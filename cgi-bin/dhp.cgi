...
A simple cgi script based on django.cgi
...
import os
import sys
if not os.environ.has_key('VIRTUALENV'):
    home = os.path.expanduser('~')
    virtualenvs = os.path.join(home, '.virtualenvs')
    os.environ['VIRTUALENV'] = os.path.join(virtualenvs, 'dhp')
